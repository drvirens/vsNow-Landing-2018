...
@interface VSMenuItemBarcodeScanView () <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@implementation VSMenuItemBarcodeScanView
...
- (void)commonInit {
  //[self initCapture];
	...
	self.layer.borderWidth = [[UIScreen mainScreen] scale] * .25f;
...
- (void)configureWithImageUrl:(NSString*)imageUrl {
  ...
  self.imageView.tintColor = [VSUIUtils brandColor];
